...
import { dashboardStats } from "@/data/constants";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        <div className="flex justify-between items-start">
          <div>
            ...
            <h3 className="text-3xl font-bold">{dashboardStats.specialRequests}</h3>
          </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        ...
        <div className="mt-4 text-sm text-gray-500">
          <span className="text-red-500 font-medium">Cần chú ý</span> cho bữa trưa
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
        ...
        <div className="mt-4 text-sm text-gray-500">
          <span className="text-yellow-500 font-medium">3 mặt hàng</span> sắp hết
        </div>
      </div>
    </div>
  );
